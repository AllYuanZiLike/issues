...
const login = reactive({ username: "", password: "", captcha: "", uuid: "", grant_type: "password" });
...
const getCaptchaUrl = () => {
  login.uuid = getUuid();
  state.captchaUrl = `${app.api}/auth/captcha?uuid=${login.uuid}`;
};
