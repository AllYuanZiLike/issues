    ...
    getNumber() {
      ...
      for (let i = 0; i < this.dataList.length; i++) {
        if (this.dataList[i].status === 2) {
          console.log("1 " + this.dataList[i].endTime);
          this.dataList[i].endTime = dayjs(this.dataList[i].endTime).format("YYYY-MM-DD HH:mm:ss")
          console.log("2 " + this.dataList[i].endTime);
        }
      }
    },
    /**
